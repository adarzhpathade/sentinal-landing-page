...
const prepStops = (
  stops?: string[]
): { arr: Array<[number, number, number]>; count: number } => {
...
`;
    ...
    const effectiveColors =
      gradientColors || (color1 && color2 ? [color1, color2] : undefined);
    const { arr: colorArr, count: colorCount } = prepStops(effectiveColors);
