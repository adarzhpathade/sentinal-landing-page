...
export function AnimatedFooter({
  ...
  return (
    <footer
      ref={rootRef}
      className={cn(
        "relative min-h-[70svh] h-[70svh] md:min-h-[80svh] md:h-[80svh] w-full overflow-hidden bg-[#141314]",
    ...
    >
      ...
      {/* Content overlay */}
      <div className="relative z-10 flex h-full w-full flex-col justify-between p-8 md:p-12 text-[11px] font-mono tracking-widest text-[#ffffff]/50">
        ...
        {/* Bottom Row — Mobile Copyright & Product Tag */}
        <div className="flex flex-col gap-8 mt-auto pt-8 items-center w-full">
